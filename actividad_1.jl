...
# ╔═╡ 80545705-ee45-4fc3-9038-daa3c9700fbd
using LinearAlgebra, Plots, Polynomials

# ╔═╡ 3e747320-58a2-11ef-28b0-ff4716e814bf
md"""
# Análisis Numérico 2024 
"""

# ╔═╡ b00bb9d3-64c0-47ed-9f44-ee11e521d41d
md"""
## Actividad N°1
"""

# ╔═╡ 19acc9bd-db44-45af-9edc-ecc9529851f5
md"""
!!! note "Ejercicio 1"
...
# ╔═╡ 114a2316-bec8-4b9d-9457-ffe76aa5e2e7
...
# ╔═╡ 92ae8f20-b980-44d1-a357-215b751c5eda
function derivada(u, x, h; metodo="forward")
...
# ╔═╡ df3d6c0a-047b-41ca-80f2-b6d2b9ac5aa8
begin

	u(x) = sin(x)
	x0 = 1
	hs = [0.1, 0.05, 0.01, 0.005, 0.001, 0.0005, 0.0001, 1e-8]
	metodos = ["forward", "backward", "centrada"]
	real = cos(1)

	function error_derivada(u, x, h, real; metodo="forward")
		println("Error con método $metodo para h =  $h : $(abs(real - derivada(u,x,h, metodo=metodo)))")
	end
	
	for h in hs
		for metodo in metodos
			error_derivada(u, x0, h, real, metodo=metodo)
		end
	end
	
end

# ╔═╡ e03d3857-c0bb-425c-add3-fb97b164f3a4
md"""
---
"""

# ╔═╡ 251aeb8e-541f-4f90-9694-4685f5d29112
md"""
### Capa límite
...
# ╔═╡ 8eb817c4-7fe7-47eb-91c0-caec6f253909
md"""
!!! note "Ejercicio 2"
...
# ╔═╡ 57fdd2f8-601a-46f4-aef9-dfa7736ef909
md"""
!!! terminology "Nota"
...
# ╔═╡ 8e7d574b-1c9e-49f2-87b8-4011d53f84c1
#completar
...
manifest_format = "2.0"
project_hash = "05c53656013d487a783cb7b4768faacb834c50bf"
